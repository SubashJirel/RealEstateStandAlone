...
interface LiveHomePropertyCardProps {
  property: LiveListingProperty;
  className?: string;
}

const PROPERTY_BASE_PATH = "/template-preview/luxury-agency/properties";

export function LiveHomePropertyCard({ property, className }: LiveHomePropertyCardProps) {
      ...
      <div className="p-5">
        ...
        <div className="mt-5 grid grid-cols-3 gap-3 border-y border-light-border py-4 text-sm text-on-surface-variant">
          <span className="flex items-center gap-2">
            ...
            {property.beds > 0 ? property.beds : "Studio"} Beds
          </span>
          <span className="flex items-center gap-2">
